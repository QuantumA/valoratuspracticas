...
<nav role="navigation" class="navbar navbar-default navbar-fixed-top">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-left">
            ...
            <li><a href="mi_empresa_{$gerente->id_empresa}">Mi empresa</a></li>
        </ul>
        <ul class="nav navbar-nav navbar-right"style="margin-right: 7mm">
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{$gerente->login}<span class="caret"></span></a>
